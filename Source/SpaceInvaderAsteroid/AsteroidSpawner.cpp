...
void AAsteroidSpawner::BeginPlay()
{
	...
	GetWorldTimerManager().SetTimer(TimerHandle, this, &AAsteroidSpawner::SpawnAsteroid, SpawnIntervalInSeconds, true, 0.0f);
}
...
{
	float randNum1 = rand() % (2 * (MapSize - 100)) - (MapSize - 100);
	float randNum2 = FMath::RandRange(1, 4);
